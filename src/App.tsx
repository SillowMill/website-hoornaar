...
const CONFIG = {
  // Business identity
  name: "Hoornaar & Wespenservice Hageland",
  tagline: "Erkend bestrijder van wespen en Aziatische hoornaars.",
  logoUrl: "/logo.png",
  logoAlt: "Hoornaar & Wespenservice Hageland Logo",
  logoClassName: "h-6 md:h-8",

  // Contact
  phone: "0456 95 11 12",
  phoneLink: "tel:+32456951112",
  email: "info@hoornaar-wespenservice-hageland.be",
  whatsapp: "https://wa.me/32456951112",

  // Location
  address: "Aarschot en het Hageland",
  region: "Aarschot en het Hageland",
  regionShort: "Hageland",
  country: "België",
  ...
  // About text
  aboutText: "Hoornaar & Wespenservice Hageland wordt gerund door Dorian Laenen, professioneel brandweerman en ambulancier. Met gespecialiseerde uitrusting zoals cameragestuurde telescopische lansen biedt hij veilige en efficiënte bestrijding van wespen en Aziatische hoornaars. Gifvrij waar mogelijk, met 7 dagen garantie.",
